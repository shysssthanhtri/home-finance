...
export const MemberForm = forwardRef<Ref, Props>((props, ref) => {
  const { member, isPending, onSubmit } = props;
...
const formSchema = UserEntity.and(TeamMemberSchema.pick({ role: true }));
